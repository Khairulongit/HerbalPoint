...
import com.tchnodynamic.herbalpoint.Adapters.CartAdapter
...
import com.tchnodynamic.herbalpoint.databinding.ActivityCartBinding
...
//        ab!!.setDisplayHomeAsUpEnabled(true)
        ...
        binding.addProductToCartnew.setOnClickListener {
            ...
            val intent = Intent(applicationContext, UserFinalOrderActivity::class.java)
...
//        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK + Intent.FLAG_ACTIVITY_CLEAR_TASK)
    ...
    private fun getcart(textView: TextView) {
        ...
        var CartListref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Cart List").child("User View").child(
