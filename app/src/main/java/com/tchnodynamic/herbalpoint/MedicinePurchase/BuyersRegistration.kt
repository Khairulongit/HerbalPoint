...
import com.tchnodynamic.herbalpoint.databinding.ActivityBuyersRegistrationBinding

class BuyersRegistration : AppCompatActivity() {
    private lateinit var binding: ActivityBuyersRegistrationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBuyersRegistrationBinding.inflate(layoutInflater)
    ...
    private fun registerbuyer() {
        ...
        when {
            ...
            (!pincode.matches(pincoderegex))->{
                Toast.makeText(this, "WARNING: Enter Valid PinCode!", Toast.LENGTH_SHORT).show() }
                ...
                val rootref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Buyers")
