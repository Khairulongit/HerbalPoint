...
import com.tchnodynamic.herbalpoint.databinding.ActivityProductDetailsBinding
...
//        ab!!.setDisplayHomeAsUpEnabled(true)
    ...
    private fun alreadyincart()  {
        ...
        val CartListref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Cart List").child("User View")?.child(
            FirebaseAuth.getInstance().currentUser!!.uid)?.child("In Cart Item")
...
//                        finish()
    ...
    private fun updatecart(orderid: String) {
        ...
        FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Cart List").child("User View")?.child(FirebaseAuth.getInstance().currentUser!!.uid)?.child("In Cart Item").child(orderid).child("quantity").setValue(binding.numberBtn.number)
        FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Cart List").child("User View")?.child(FirebaseAuth.getInstance().currentUser!!.uid)?.child("In Cart Item").child(orderid).child("price").setValue(binding.productDetailsPrice.text.toString())
...
//        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK + Intent.FLAG_ACTIVITY_CLEAR_TASK)
    ...
    private fun addTocartList() {
        ...
        cartListRef= FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Cart List").child("User View")?.child(FirebaseAuth.getInstance().currentUser!!.uid)?.child("In Cart Item")
...
//                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK + Intent.FLAG_ACTIVITY_CLEAR_TASK)
    ...
    private fun getproductdetails(productId: String, sellerid: String) {
        ...
        val Productref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Products").child("CcXrsQnCmka1OKm9r5HBehJrdqq1")
