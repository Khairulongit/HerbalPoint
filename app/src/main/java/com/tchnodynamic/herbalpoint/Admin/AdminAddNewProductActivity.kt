...
import com.tchnodynamic.herbalpoint.databinding.ActivityAdminAddNewProductBinding
...
//        ab!!.setDisplayHomeAsUpEnabled(true)
    ...
    private fun StoreprodcutInformation() {
        ...
        storeprodref= FirebaseStorage.getInstance().reference.child("Herbal Point").child("Products Images").child(
            FirebaseAuth.getInstance().currentUser.toString())

        val fileRef = storeprodref!!.child("Herbal Point").child(System.currentTimeMillis().toString() + ".jpg")  // creating the file first
        ...
        uploadtask.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
            ...
            if (task.isSuccessful) {   // if upload task is suucessful
                ...
                val productref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Products").child(
                ...
                newprodcutpmap["description"] = binding.produtcDesc.text.toString()
...
//                newprodcutpmap["sellerid"] = sellerid
    ...
    private fun sellerinformation() {
        ...
        val sellerref = FirebaseDatabase.getInstance().reference.child("Herbal Point").child("Sellers").child(mAuth.currentUser!!.uid)
